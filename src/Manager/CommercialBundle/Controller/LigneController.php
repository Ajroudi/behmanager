...
use Manager\CommercialBundle\Entity\Ligne;
use Manager\CommercialBundle\Form\LigneType;
...
class LigneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ManagerCommercialBundle:Ligne')->findAll();

        return $this->render('ManagerCommercialBundle:Ligne:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ManagerCommercialBundle:Ligne:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    private function createCreateForm(Ligne $entity)
    {
        ...
        $form->add('submit', 'submit', array('label' => 'Ajouter une ligne','attr' => array('class' => 'btn btn-primary btn-block')));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ManagerCommercialBundle:Ligne')->find($id);
        ...
        return $this->render('ManagerCommercialBundle:Ligne:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ManagerCommercialBundle:Ligne:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    private function createEditForm(Ligne $entity)
    {
        ...
        $form->add('submit', 'submit', array('label' => 'Editer la ligne','attr' => array('class' => 'btn btn-primary btn-block')));
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ...
            ->setMethod('DELETE')
            ->add('submit', 'submit', array('label' => 'Supprimer la ligne','attr' => array('class' => 'btn btn-danger btn-block')))
            ->getForm()
        ;
    }
}
