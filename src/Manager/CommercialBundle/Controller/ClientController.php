...
use Manager\CommercialBundle\Entity\Client;
use Manager\CommercialBundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ManagerCommercialBundle:Client:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    private function createCreateForm(Client $entity)
    {
        ...
        $form->add('submit', 'submit', array('label' => 'Ajouter un client','attr' => array('class' => 'btn btn-primary btn-block')));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ManagerCommercialBundle:Client')->find($id);
        ...
        return $this->render('ManagerCommercialBundle:Client:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ManagerCommercialBundle:Client:edit.html.twig', array(
            'entity'      => $entity,
